...
namespace BlackJackUI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Press any key to deal the cards and begin the game...");
            Console.ReadKey();
            ...
            else if (drawncard == 2 || drawncard == 15 || drawncard == 28 || drawncard == 41)
            {
                ...
                Console.WriteLine($"The Dealer has drawn a 2 and his hand is now at 2");
            }
            else if (drawncard == 3 || drawncard == 16 || drawncard == 29 || drawncard == 42)
            {
                drawncard = 3;
                //dhand.Add(drawncard);
                dealer.OpenValue = drawncard;
                Console.WriteLine($"The Dealer has drawn a 3 and his hand is now at 3");
            }
            else if (drawncard == 4 || drawncard == 17 || drawncard == 30 || drawncard == 43)
            {
                drawncard = 4;
